...
object Runner {
  ...
  def main(args: Array[String]) = {
    ...
    // Parser to test!
    //val parser = new SingleDigitParser(reader)
    //val parser = new SingleAddOpParser(reader)
    //val parser = new MultipleAddOpParser(reader)
    //val parser = new ArithOpParser(reader)
